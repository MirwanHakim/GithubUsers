...
public final class ActivitySettingBinding implements ViewBinding {
  ...
  private ActivitySettingBinding(@NonNull LinearLayout rootView, @NonNull FrameLayout settings) {
  ...
  public static ActivitySettingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySettingBinding((LinearLayout) rootView, settings);
    }
